...
#[post("/register")]
async fn register(pool: Data<PgPool>, Json(create_user): Json<CreateUser>) -> impl Responder {
...
#[post("/login")]
pub async fn login(pool: Data<PgPool>, login: Json<LoginUserRequest>) -> impl Responder {
